...
// Game loops: Continue the battle until one character's health reaches 0
        while (((Character) warrior).isAlive(((Character) warrior).health) && ((Character) mage).isAlive(((Character) mage).health)) {
// Warrior attacks Mage
            warrior.attack();
            ((Character) mage).setHealth(((Character) mage).getHealth() - 10);
            if (!((Character) mage).isAlive(((Character) mage).health)) {
...
// Mage attacks Warrior
            ...
            ((Character) warrior).setHealth(((Character) warrior).getHealth() -
                    15);
            if (!((Character) warrior).isAlive(((Character) warrior).health)) {
